import { AUDIO_STREAM_TYPE } from "/js/player/lib/pull_demuxer_base.js";
import { RingBuffer } from "/js/player/third_party/ringbufjs/ringbuf.js";
...
export class AudioRenderer {
  async initialize(demuxer) {
    ...
    console.log("demuxer",demuxer.source.getAudioSpecificConfig())
